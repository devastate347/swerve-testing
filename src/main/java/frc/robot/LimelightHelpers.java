...
public class LimelightHelpers {
  ...
  public record RawFiducial(
    ...
    public String toString() {
      return String.format(
          ...
          TYNC: %.2f
          TA: %.2f
          Distance to Camera: %.2f meters
          Distance to Robot: %.2f meters
          Ambiguity: %.2f
          """,
  ...
  public record PoseEstimate(
    ...
    public String toString() {
      return String.format(
          ...
          Tag Count: %d
          Tag Span: %.2f meters
          Average Tag Distance: %.2f meters
          Average Tag Area: %.2f%% of image
          Is MegaTag2: %b
          """,
          timestampSeconds, latency, tagCount, tagSpan, avgTagDist, avgTagArea, isMegaTag2);
    }
  }
  ...
  private static double extractArrayEntry(double[] inData, int position) {
    if (inData != null && position < inData.length) {
      return inData[position];
    }
    return 0;
  }

  private static PoseObservation getBotPoseEstimate(
    ...
    if (poseArray.length == 0) {
      ...
      return new PoseObservation(); // or some default PoseEstimate
    }
   ...
   * @return
   */
  public static PoseObservation getBotPoseEstimate_wpiBlue(String limelightName) {
   ...
   * @return
   */
  public static PoseObservation getBotPoseEstimate_wpiBlue_MegaTag2(String limelightName) {
   ...
   * @return
   */
  public static PoseObservation getBotPoseEstimate_wpiRed(String limelightName) {
   ...
   * @return
   */
  public static PoseObservation getBotPoseEstimate_wpiRed_MegaTag2(String limelightName) {
